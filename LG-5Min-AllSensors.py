...
import pandas as pd
import time as tm
dataset = load_files("./Training Data/5Min", load_content=False)
max_epoch = 10
patience = 3
test_count = 1700
validation_count = 1700
...
with open("./Model Results/lg/5min/allsensors/results_{:.0f}.json".format(tm.time()), "w") as f:
    f.write(dumps({
